    ...
    if checkpoint_path and os.path.isfile(checkpoint_path):
        ...
        if state_dict_key and state_dict_key in checkpoint:
            ...
            for k, v in checkpoint[state_dict_key].items():
                # strip `module.` prefix
                if checkpoint[state_dict_key][k].shape==model.state_dict()[k].shape:
        ...
        #     del state_dict['module.head' + '.weight']
        #     del state_dict['module.head' + '.bias']

        if del_posemb==True:
            del state_dict['module.pos_embed']

        old_posemb = state_dict['module.pos_embed']
        if model.pos_embed.shape != old_posemb.shape:  # need resize the position embedding by interpolate
            ...
            state_dict['module.pos_embed'] = new_posemb
