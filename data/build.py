...
def build_transform(is_train, config):
    ...
    if is_train:
        if config.DATA.DATASET == 'flood':
            ...
            transforms.ToTensor(),
            transforms.Lambda(lambda crops:torch.cat([transforms.ColorJitter(brightness=(1,1.2),contrast=(1,1.1),saturation=0, hue=0)(crop) for crop in [crops[:3,:,:],crops[3:,:,:]]],dim=0)),
