...
# loss weight
# _C.TRAIN.LOSS_WEIGHT = [0.909,2.174,0.763,2.778]#jn
# _C.TRAIN.LOSS_WEIGHT = [1.064,1.075,2.174,1.075]#paki
# _C.TRAIN.LOSS_WEIGHT = [1.613,1.6,0.952,1.2]#tai
# _C.TRAIN.LOSS_WEIGHT = [0.18,0.17,0.62,1]#jn+paki
_C.TRAIN.LOSS_WEIGHT = [1,1,0,0]
...
def update_config(config, args):
    ...
    #capsnet 参数
    config.with_reconstruction = args.with_reconstruction
    config.routing_iterations = args.routing_iterations
